...
public interface ITaskService
{
    ...
    Task<Tasks> CreateTaskAsync(string title, string description, Priority priority, DateTimeOffset? dueDate = null, string? assignedTo = null, int? timeEstimateMinutes = null, WorkStatus status = WorkStatus.NotAssigned);
